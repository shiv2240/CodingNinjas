...
const features = [
  {
    ...
    description:
      "Simply speak to our assistant and we will collect all the necessary information for your eKatha document.",
  },
  {
    icon: "verified",
    title: "BBMP Compliant",
    description:
      "Our system is fully compliant with all BBMP requirements and regulations for property documentation.",
  },
  {
    icon: "speed",
    title: "Fast Processing",
    description:
      "Get your eKatha document processed in record time with our streamlined digital workflow.",
  },
  {
    icon: "security",
  ...
  },
  {
    ...
    description:
      "Communicate in your preferred language with our assistant that supports multiple Indian languages.",
  },
];
    ...
    <section id="features" className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Our voice assistant makes creating eKatha documents for BBMP
            properties simple, secure, and efficient.
          </motion.p>
        </div>
              ...
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                >
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-semibold mr-3">
                      1
                    </div>
                    <div>
                      ...
                      <p className="text-secondary">
                        Click the "Start Voice Assistant" button to begin the
                        process.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary">
                        Answer the assistant's questions about your property and
                        personal details.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary">
                        Review the collected information and confirm submission.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary">
                        Get your completed eKatha document via email or download
                        it directly.
                      </p>
                    </div>
                  </li>
